...
$productID = $connect->query("SELECT product_id FROM cart");
foreach( $productID as $key=>$pro):
  $pro_id = $pro["product_id"];
$product = $connect->query("SELECT * FROM products WHERE id=$pro_id");
...
<div class="row align-items-center">
<div class="col-lg-1 col-md-1 col-12">
<a href="product-details.html"><img src="../admin/images/<?= $image[0] ?>" alt="#"></a>
</div>
<div class="col-lg-4 col-md-3 col-12">
...
<div class="col-lg-1 col-md-2 col-12">
<a class="remove-item" href="fun/cart/delete.php?id=<?= $val["id"] ?>"><i class="lni lni-close"></i></a>
</div>
</div>
</div>
