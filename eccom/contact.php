...
<input class="_name" name="name" type="text" placeholder="Your Name" >
</div>
</div>
<div class="col-lg-6 col-md-6 col-12">
<div class="form-group">
<input class="_subject" name="subject" type="text" placeholder="Your Subject" >
</div>
</div>
<div class="col-lg-6 col-md-6 col-12">
<div class="form-group">
<input class="_email" name="email" type="email" placeholder="Your Email" >
</div>
</div>
<div class="col-lg-6 col-md-6 col-12">
<div class="form-group">
<input class="_phone" name="phone" type="text" placeholder="Your Phone" >
</div>
</div>
<div class="col-12">
<div class="form-group message">
<textarea class="_message" name="message" placeholder="Your Message"></textarea>
</div>
</div>
<div class="col-12">
<div class="form-group button">
<button type="submit" class="btn sub">Submit Message</button>
</div>
</div>
</div>
</form>
