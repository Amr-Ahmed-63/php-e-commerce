...
<main id="gallery">
    <div class="main-img">
<img src="../admin/images/<?= $image[0] ?>" id="current" alt="#">
</div>
<div class="images">
    <?php foreach($image as $key => $img):  ?>
<img src="../admin/images/<?= $img[1] ?>" class="img" alt="">
<?php endforeach ?>
</div>
</main>
</div>
...
<div class="button cart-button">
    ...
    $id = $_GET["id"];
    ?>
    <a href="fun/cart/add.php?id=<?= $id ?>" class="btn" style="width: 100%; display: flex; align-items: center; justify-content: center;">Add to Cart</a>
</div>
</div>
<div class="col-lg-4 col-md-4 col-12">
